...
<body>
<center>
<h1>YOUR ORDER HISTORY</h1></center>
<%
...
ResultSet rs=st.executeQuery("select * from forder c inner join food f on c.fid=f.fid and c.email='"+e+"' and isdelivered='yes'");
%>
...
out.print("</table>");
if(f==0)
out.print("your order history is empty");
